...
public class AccessModifiers4 extends AccessModifiersEx
{

	public static void main(String[] args) 
	{
		System.out.println("Accessing data members in different class and same package using inheritance");
